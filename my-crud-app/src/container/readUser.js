                        ...
                        {props.user.map((item)=>{
                            return (
                                <tr>
                                    ...
                                    <svg className="delI" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <td><button id="read">
                                        <Link to='/update'
                                            state={{user:item}}>
                                                <svg xmlns="http://www.w3.org/2000/svg" className="updateI" fill="none" viewBox="0 0 24 24" stroke="currentColor">
