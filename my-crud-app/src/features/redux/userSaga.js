...
function fectchUserData() {
  ...
  return axios({
      method: 'get',
      url: 'http://localhost:8000/user' //'https://66e4f302-4181-4df5-9c50-185c6ac1f6c7.mock.pstmn.io//user',//
  })
}
...
function* deleteUserSaga(action){
  ...
  try{
      ...
      yield call(axios.delete,"http://localhost:8000/user/"+deldata.id); 
...
function* updateUserSaga(action){
  try{
      ...
      yield call(axios.put,"http://localhost:8000/user/"+putdata.id,putdata); 
